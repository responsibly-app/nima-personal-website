        ...
        <div className="grid md:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            <motion.div
              ...
              className="mt-4 bg-white/70 dark:bg-[#1a1611]/70 backdrop-blur-sm border border-[#c9a84c]/20 p-5"
            >
              <p className="text-[#5a4832] dark:text-[#c9b088] text-sm italic font-heading leading-relaxed mb-2">
          ...
          <div>
            <motion.div
              ...
              className="mb-10"
            >
              <p className="text-[#5a4832] dark:text-[#c9b088] text-lg leading-relaxed mb-5">
              ...
              {milestones.map((milestone, i) => (
                ...
                >
                  <div className="flex flex-col items-center">
                    <div className="w-3 h-3 rounded-full border-2 border-[#c9a84c] bg-[#faf7f2] dark:bg-[#0f0d0a] shrink-0 group-hover:bg-[#c9a84c] transition-colors duration-300 mt-1" />
                  ...
                  <div className="pb-3">
                    <div className="flex items-center gap-3 mb-1">
                      ...
                      <span className="text-[#1c1409] dark:text-[#f5f0e8] font-semibold">{milestone.title}</span>
                    </div>
