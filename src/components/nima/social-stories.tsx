      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          {channelStats.map((stat, i) => (
            <div
              key={stat.label}
              className="p-6 border border-[#c9a84c]/15 bg-white/60 dark:bg-[#1a1611]/60 backdrop-blur-sm text-center hover:border-[#c9a84c]/35 hover:bg-white/80 dark:hover:bg-[#1a1611]/80 transition-all duration-300"
            >
        ...
        >
          <a
            ...
            className="flex items-center gap-3 px-8 py-4 bg-[#c9a84c]/8 dark:bg-[#c9a84c]/5 border border-[#c9a84c]/30 text-[#8b6914] dark:text-[#e8c97a] text-sm font-medium tracking-wider uppercase hover:bg-[#c9a84c]/15 hover:border-[#c9a84c]/60 transition-all duration-300"
          >
